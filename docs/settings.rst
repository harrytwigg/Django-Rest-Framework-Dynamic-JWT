...
.. code-block:: python
  ...
  SIMPLE_JWT = {
      ...
      'USER_AUTHENTICATION_RULE': 'rest_framework_dynamicjwt.authentication.default_user_authentication_rule',

      'AUTH_TOKEN_CLASSES': ('rest_framework_dynamicjwt.tokens.AccessToken',),
...
You need to add ``'rest_framework_dynamicjwt.token_blacklist',`` to your 
