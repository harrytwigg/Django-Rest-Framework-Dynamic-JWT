...
Dynamic JWT includes an app that provides token blacklist functionality.  To use
...
If the blacklist app is detected in ``INSTALLED_APPS``, Dynamic JWT will add any
...
The Dynamic JWT blacklist app implements its outstanding and blacklisted token
