...
Dynamic JWT provides two different token types that can be used to prove
...
By default, Dynamic JWT expects an "access" token to prove authentication.  The
...
Be aware that, if you are using the blacklist app, Dynamic JWT will validate all
