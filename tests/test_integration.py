...
from rest_framework_dynamicjwt.tokens import AccessToken
...
class TestTestView(APIViewTestCase):
    ...
    def test_expired_token(self):
        ...
        with override_api_settings(AUTH_TOKEN_CLASSES=('rest_framework_dynamicjwt.tokens.AccessToken',)):
            res = self.view_get()
    ...
    def test_user_can_get_sliding_token_and_use_it(self):
        ...
        with override_api_settings(AUTH_TOKEN_CLASSES=('rest_framework_dynamicjwt.tokens.SlidingToken',)):
            res = self.view_get()
