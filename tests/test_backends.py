...
from rest_framework_dynamicjwt.backends import TokenBackend
from rest_framework_dynamicjwt.exceptions import TokenBackendError
from rest_framework_dynamicjwt.utils import (
...
class TestTokenBackend(TestCase):
    ...
    def test_decode_rsa_aud_iss_jwk_success(self):
        ...
        with patch("rest_framework_dynamicjwt.backends.PyJWKClient") as mock_jwk_module:
